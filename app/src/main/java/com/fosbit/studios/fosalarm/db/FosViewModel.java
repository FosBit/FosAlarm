...
public class FosViewModel extends AndroidViewModel {
    ...
    public void insertAlarms( Alarm... alarms ) {
        mRepository.insertAlarms( alarms );
    }

    public void insertMemories( Memory... memories ) {
        mRepository.insertMemories( memories );
    }

    public void updateAlarms( Alarm... alarms ) {
        mRepository.updateAlarms( alarms );
    }

    public void updateMemories( Memory... memories ) {
        mRepository.updateMemories( memories );
    }
    ...
    public void deleteMemories( Memory... memories ) {
        mRepository.deleteMemories( memories );
    }
}
